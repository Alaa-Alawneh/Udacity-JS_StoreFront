        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        hash = bcrypt.hashSync(user.password + pepper, parseInt(saltRounds));
                        return [4 /*yield*/, client.connect()];
                    case 1:
                        conn = _a.sent();
                        sql = 'INSERT INTO users (first_name, last_name, password_digest) VALUES($1, $2, $3) RETURNING id, first_name, last_name';
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not create user ".concat(user.first_name, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'UPDATE users SET first_name=$1, last_name=$2 WHERE id=$3 RETURNING id, first_name, last_name';
                        return [4 /*yield*/, conn.query(sql, [user.first_name, user.last_name, user.id])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows[0]];
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not update user ".concat(user.id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("Could not authenticate user ".concat(firstName, ". Error: ").concat(err_6));
                    case 4: return [2 /*return*/];
                }
            });
        });
